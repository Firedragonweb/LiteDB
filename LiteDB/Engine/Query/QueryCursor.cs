...
namespace LiteDB
{
    ...
    internal class QueryCursor : IDisposable
    {
        ...
        /// </summary>
        public void Fetch(TransactionService trans, DataService data, BsonReader bsonReader, bool shallowMode)
        {
            ...
            while (trans.CheckPoint() == false)
            {
                ...
                var doc = bsonReader.Deserialize(buffer, shallowMode).AsDocument;
